      ...
      <div className="mb-8 space-y-2">
         <div className="flex justify-between items-center">
           <div className="flex items-center gap-2 text-sm font-medium text-orange-600 bg-orange-50 px-3 py-1 rounded-full">
             <Flame size={14} /> Level Legend
           </div>
           <span className="text-sm font-medium text-slate-500">Soal {currentQuestionIdx + 1}/{activeEssay.length}</span>
        </div>
        ...
        {!essayFeedbackMode ? (
          <div className="flex-1 flex flex-col space-y-4">
            <div className="relative flex-1">
              <PenTool className="absolute left-3 top-3 text-slate-400" size={20} />
              <textarea 
                className="w-full h-full min-h-[200px] p-4 pl-10 rounded-xl border-2 border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 outline-none text-lg resize-none"
           ...
           <div className="flex-1 flex flex-col space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                <p className="text-xs font-bold text-slate-500 uppercase mb-2">Jawaban Kamu</p>
                <p className="text-slate-800">{essayAnswer}</p>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-xl border border-green-200 relative overflow-hidden">
                 ...
                 <p className="text-green-900 font-medium text-sm mb-2">Poin Penting:</p>
                 <p className="text-green-800 text-sm leading-relaxed">{question.modelAnswer}</p>
              </div>
