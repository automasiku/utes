  ...
  return (
    <div className="max-w-xl mx-auto py-12 px-4 text-center space-y-8">
      <div className="relative inline-block">
        <div className="w-48 h-48 rounded-full border-8 border-slate-100 flex items-center justify-center bg-white shadow-xl">
          <div>
            <span className={`text-5xl font-bold block ${color}`}>{score}/{totalQuestions}</span>
            <span className="text-slate-400 text-sm font-medium">Benar</span>
          </div>
        </div>
