  ...
  return (
    <div className="max-w-xl mx-auto py-12 px-4 space-y-6">
      <div className="bg-green-50 border border-green-100 rounded-2xl p-6 text-center space-y-4">
        ...
        <h2 className="text-xl font-bold text-green-900">Materi Terkonfirmasi!</h2>
        <p className="text-green-800">
          Sistem siap membuat latihan soal berdasarkan data yang kamu berikan.
        </p>
        
        <div className="bg-white/60 rounded-xl p-4 text-left space-y-2 text-sm border border-green-100">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-semibold text-slate-800 truncate max-w-[200px]">{progressTopic || "Materi Lengkap"}</span>
          </div>
        </div>
