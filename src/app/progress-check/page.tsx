...
export default function ProgressCheckPage() {
  ...
  return (
    <div className="max-w-xl mx-auto py-12 px-4 space-y-6">
      ...
      <div>
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Tentukan Batas Materi</h2>
        <p className="text-slate-600">Bantu sistem memahami sejauh mana kamu belajar agar soal yang dibuat relevan.</p>
      </div>
      ...
      <Card className="space-y-6">
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-10 p-3 rounded-lg border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none"
              value={progressTime}
        ...
        <div>
          ...
          <textarea 
            ...
            className="w-full p-3 rounded-lg border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none resize-none"
            value={progressTopic}
